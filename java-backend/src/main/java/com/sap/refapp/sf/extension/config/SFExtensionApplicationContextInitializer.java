 ...
 *
 */
@EnableJpaRepositories(basePackages = "com.sap.refapp.sf.extension.repository")
public class SFExtensionApplicationContextInitializer
implements ApplicationContextInitializer<ConfigurableApplicationContext> {

	private static final Logger logger = LoggerFactory.getLogger(SFExtensionApplicationContextInitializer.class);
